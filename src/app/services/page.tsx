	...
	return (
		<PublicLayout>
				...
				<div className="container mx-auto px-4 relative z-10">
					<div className="max-w-3xl mx-auto text-center">
						<h1 className="text-4xl md:text-6xl font-bold mb-6">
							Our <span className="bg-gradient-to-r from-blue-500 to-purple-500 text-transparent bg-clip-text">Services</span>
						</h1>
			...
			<section className="py-20 bg-gray-950">
				<div className="container mx-auto px-4">
					<div className="max-w-3xl mx-auto text-center mb-16">
						<h2 className="text-3xl font-bold mb-6">How We Support Founders</h2>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
						...
						<Card className="bg-gray-900 border-gray-800">
							<CardHeader className="pb-4">
								...
								<CardDescription className="text-gray-400">Access to a curated network of exceptional founders</CardDescription>
							</CardHeader>
							<CardContent>
						...
						<Card className="bg-gray-900 border-gray-800">
							<CardHeader className="pb-4">
								...
								<CardDescription className="text-gray-400">Resources to help you secure the capital you need</CardDescription>
							</CardHeader>
							<CardContent>
								<ul className="space-y-2 text-gray-300">
									<li className="flex items-start">
						...
						<Card className="bg-gray-900 border-gray-800">
							<CardHeader className="pb-4">
								...
								<CardDescription className="text-gray-400">Continuous learning opportunities to level up</CardDescription>
							</CardHeader>
							<CardContent>
								<ul className="space-y-2 text-gray-300">
									<li className="flex items-start">
						...
						<Card className="bg-gray-900 border-gray-800">
							<CardHeader className="pb-4">
								...
								<CardDescription className="text-gray-400">Technical resources to build better products</CardDescription>
							</CardHeader>
							<CardContent>
								<ul className="space-y-2 text-gray-300">
									<li className="flex items-start">
						...
						<Card className="bg-gray-900 border-gray-800">
							<CardHeader className="pb-4">
								...
								<CardDescription className="text-gray-400">Launch and scale your product effectively</CardDescription>
							</CardHeader>
							<CardContent>
								<ul className="space-y-2 text-gray-300">
									<li className="flex items-start">
						...
						<Card className="bg-gray-900 border-gray-800">
							<CardHeader className="pb-4">
								...
								<CardDescription className="text-gray-400">Infrastructure to run your startup efficiently</CardDescription>
							</CardHeader>
							<CardContent>
								<ul className="space-y-2 text-gray-300">
									<li className="flex items-start">
			...
			<section className="py-24 bg-black overflow-hidden">
				<div className="container mx-auto px-4">
					<div className="max-w-3xl mx-auto text-center mb-16">
						<h2 className="text-3xl font-bold mb-6">Premium Programs</h2>
						<p className="text-lg text-gray-400">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
						<Card className="bg-gradient-to-br from-blue-900/40 to-purple-900/40 border-blue-800/50">
							<CardHeader>
								...
								<CardDescription className="text-gray-300">For early-stage founders with just an idea</CardDescription>
							</CardHeader>
							<CardContent>
						...
						<Card className="bg-gradient-to-br from-purple-900/40 to-pink-900/40 border-purple-800/50">
							<CardHeader>
								...
								<CardDescription className="text-gray-300">For seed-stage startups ready to scale</CardDescription>
							</CardHeader>
							<CardContent>
								<p className="text-gray-300 mb-4">
			...
			<section className="py-24 bg-gray-950 overflow-hidden">
				<div className="container mx-auto px-4">
					<div className="max-w-3xl mx-auto text-center mb-16">
						<h2 className="text-3xl font-bold mb-6">Recurring Events & Workshops</h2>
						<p className="text-lg text-gray-400">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
						<div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
							...
							<h3 className="text-xl font-bold mb-2">Founder Dinner Series</h3>
							<p className="text-gray-400 mb-2">Monthly networking dinners with founders, investors, and industry experts.</p>
							<p className="text-sm text-gray-500">Every last Thursday of the month</p>
						</div>
						...
						<div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
							...
							<h3 className="text-xl font-bold mb-2">Weekend Hackathons</h3>
							<p className="text-gray-400 mb-2">48-hour intense building sessions with mentorship and prizes.</p>
							<p className="text-sm text-gray-500">First weekend of each quarter</p>
						</div>
						...
						<div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
							...
							<h3 className="text-xl font-bold mb-2">VC Office Hours</h3>
							<p className="text-gray-400 mb-2">One-on-one sessions with VCs from top firms.</p>
							<p className="text-sm text-gray-500">Every Wednesday afternoon</p>
						</div>
						...
						<div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
							...
							<p className="text-gray-400 mb-2">Hands-on sessions on emerging technologies and development practices.</p>
							<p className="text-sm text-gray-500">Bi-weekly on Tuesdays</p>
						</div>
						...
						<div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
							...
							<h3 className="text-xl font-bold mb-2">Founder Book Club</h3>
							<p className="text-gray-400 mb-2">Discussions on essential startup and business literature.</p>
							<p className="text-sm text-gray-500">Monthly on first Monday</p>
						</div>
						...
						<div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
							...
							<p className="text-gray-400 mb-2">Showcase your startup to investors, press, and the community.</p>
			...
			<section className="py-24 bg-black overflow-hidden">
				<div className="container mx-auto px-4">
					<div className="max-w-3xl mx-auto text-center mb-16">
						<h2 className="text-3xl font-bold mb-6">Partner Services & Perks</h2>
						<p className="text-lg text-gray-400">
					...
					<div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
						<div className="text-center">
							...
							<p className="text-sm font-medium">$100K AWS Credits</p>
						</div>
						...
						<div className="text-center">
							...
							<p className="text-sm font-medium">$20K Fee-Free Processing</p>
						</div>
						...
						<div className="text-center">
							...
							<p className="text-sm font-medium">90% off HubSpot for 1 year</p>
						</div>
						...
						<div className="text-center">
							...
							<p className="text-sm font-medium">Free Notion Team Plan</p>
						</div>
					</div>
