...
export default function HomePage() {
	// Sample featured houses
	// const featuredHouses = [
	// 	{
	// 		id: "sf-nob-hill",
	// 		name: "San Francisco - Nob Hill",
	// 		description: "Our flagship location in the heart of San Francisco with stunning city views.",
	// 		location: { city: "San Francisco", state: "CA" },
	// 		imageUrl: "/images/sf-house.jpg", // Add placeholder images in public/images/
	// 	},
	// 	{
	// 		id: "nyc-brooklyn",
	// 		name: "New York - Brooklyn",
	// 		description: "Creative space for founders in the vibrant Brooklyn tech scene.",
	// 		location: { city: "New York", state: "NY" },
	// 		imageUrl: "/images/nyc-house.jpg",
	// 	},
	// ];
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
						<div className="space-y-6">
							...
							<p className="text-lg md:text-xl text-gray-300 max-w-lg">
								Join a community of founders, builders, and innovators in a high-talent-density living environment designed to help you succeed.
							</p>
				...
				<div className="container mx-auto px-4">
					<div className="text-center max-w-3xl mx-auto mb-16">
						...
						<p className="text-gray-400">
							We've designed our houses with founders in mind, providing everything you need to build, connect, and succeed.
						</p>
					</div>
				...
				<div className="container mx-auto px-4">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
						{featuredHouses.map((house) => (
							<div key={house.id} className="bg-gray-900 rounded-lg overflow-hidden border border-gray-800 shadow-lg">
								<Image src={house.imageUrl} alt={house.name} fill className="object-cover" />
								<div className="p-6">
			...
			<section className="py-20 bg-black">
				<div className="container mx-auto px-4">
					<div className="max-w-4xl mx-auto text-center">
						...
						<p className="text-xl text-gray-400 mb-10 mx-auto max-w-2xl">
							Apply today to join our community of founders and innovators. Limited spots available.
						</p>
						<Button asChild size="lg">
							<Link href="/apply">
								Apply Now
